	...
	intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>>{
        ...
        function handleRoute() {
            switch (true) {
				...
				case url.endsWith('/patients/allpatient') && method === 'GET': return next.handle(request);
				case url.includes('/patients/delete') && method === 'DELETE': return next.handle(request);
				case url.endsWith('/patients/applicants') && method === 'GET': return next.handle(request);
