...
import { Appointment, AppointmentEvent, Examination } from 'src/app/_providers/types';
import { ok, error } from './responses';

export function handleExaminationRequests(request: HttpRequest<any>): Observable<HttpEvent<any>> | undefined {
